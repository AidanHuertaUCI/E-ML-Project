...
# List the code(s) written entirely by your team. Please mention roughly how
...
Scripts/functions written by our team:
  • AAA.py Converts tweets into bag of words format (50 lines)
  • BBB.py Identifies the top K features in a tree-based classifier (120 lines)
